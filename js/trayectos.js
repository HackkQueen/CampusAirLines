let trayectos=document.querySelector('#trayectos');
trayectos.addEventListener('submit', (x)=>{
...
const postguardar=async(data)=>{
    ...
    let res=await (await fetch("http://localhost:4020/trayectos", config)).json(); //los datos que se envian al servidor
    getlistar();
}