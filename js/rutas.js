let rutas=document.querySelector('#rutas');
rutas.addEventListener('submit', (x)=>{
...
const postguardar=async(data)=>{
    ...
    let res=await (await fetch("http://localhost:4020/rutas", config)).json(); //los datos que se envian al servidor
    getlistar();
}